    ...
    <div class="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
        <div class="md:flex md:justify-between">
          <div class="mb-6 md:mb-0">
                  ...
                  <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Awka tech community</span>
  
          </div>
          <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
              <div>
                  <h2 class="mb-6 text-sm font-semibold text-white uppercase dark:text-white">Community</h2>
              ...
              <div>
                  ...
                  <ul class="text-white dark:text-white font-medium">
                      <li class="mb-4">
                          <a href="https://linkdin/ntsAwka" class="hover:underline ">Linkdin</a>
                      </li>
                      <li>
                          <a href="https://Awkatechmeetup" class="hover:underline">Slack</a>
                      </li>
                  </ul>
              </div>
              <div>
